...
query_fn_1 = queries.get_ticket_medio_por_forma_pagamento_query_fn
df1 = queries.execute_query_fn(query_fn_1)
if df1 is not None:
    # st.dataframe(df1)
...
query_fn_2 = queries.get_top_selling_products_query_fn
df2 = queries.execute_query_fn(query_fn_2)
if df2 is not None:
    # st.dataframe(df2)
    df2['nome'] = df2.apply(
...
query_fn_3 = queries.get_top_artists_query_fn
df3 = queries.execute_query_fn(query_fn_3)
if df3 is not None:
    # st.dataframe(df3)
...
query_fn_4 = queries.get_top_collections_by_unique_cards_query_fn
df4 = queries.execute_query_fn(query_fn_4)
if df4 is not None:
    # st.dataframe(df4)
...
query_fn_5 = queries.get_price_volatility_query_fn
df5 = queries.execute_query_fn(query_fn_5)
if df5 is not None:
